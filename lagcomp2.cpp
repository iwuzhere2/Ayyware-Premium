...
void BackTrack::UpdateRecord(int i, IClientEntity* pEntity)
{
...
{
	if (Menu::Window.LegitBotTab.AimbotBacktrack.GetState() || Menu::Window.RageBotTab.AccuracySpread.GetState())
	{
