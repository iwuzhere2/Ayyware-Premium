...
#pragma region AntiAim
	...
	AntiAimYaw.AddItem("LBY DMG");
	AntiAimYaw.AddItem("LBY Killer");
...
#pragma region Options
	...
	OptionsTrace.SetFileId("opt_trace");
	OptionsTrace.SetBoundaries(0.f, 10000.f);
	OptionsTrace.SetValue(1.5f);
	OptionsGroup.PlaceLabledControl("Trace Distance", this, &OptionsTrace); 
	

	BulletTrace.SetFileId("opt_bullettrace");
	OptionsGroup.PlaceLabledControl("Draw Antiaim visability", this, &BulletTrace);
