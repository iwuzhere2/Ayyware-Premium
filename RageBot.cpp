...
bool CRageBot::AimAtPoint(IClientEntity* pLocal, Vector point, CUserCmd *pCmd, bool &bSendPacket,CBaseCombatWeapon* pWeapon)
{
...
namespace AntiAims
{
	...
	void Zero(CUserCmd *pCmd, bool &bSendPacket)
	{
...
void DoFakeAA(CUserCmd* pCmd, bool& bSendPacket, IClientEntity* pLocal)
{
	...
	case 14:
		...
		break;
	case 15:
		AntiAims::fakeLBYDMG(pCmd, bSendPacket);
		break;
	}
